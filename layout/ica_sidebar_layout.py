...
def create_compute():
    return html.Div([
        ...
        html.Div([
            ...
            html.Label("Number of Components:", style={**LABEL_STYLES["classic"]}),
            dbc.Input(
        ...
        html.Div([
            html.Label("Max Iterations for Convergence:", style={**LABEL_STYLES["classic"]}),
        ...
        html.Div([
            html.Label("Temporal decimation (s):", style={**LABEL_STYLES["classic"]}),
        ...
        dcc.Loading(
            ...
            type="default", 
            children=[
                html.Div(id="ica-status", style={"marginTop": "10px", "marginBottom": "20px"})
            ]),

        # History Section
        html.Div([
            html.H6([html.I(className=f"bi {ICON['ICA']}"), " ICA History"], style={"fontWeight": "bold", "marginBottom": "10px"}),  # Title for the history section
