	...
	return html.Div(
		[
			...
			html.Div(
				...
				children=[
					dbc.Button(
						html.I(className="bi bi-arrow-clockwise", style={"color": "white"}),
						id=update_button_id,
						n_clicks=0,
						outline=True,
						style={
					...
					dbc.Tooltip("Refresh the graph after modifying the display parameters", target=update_button_id, placement="bottom"),
					...
					dbc.Tooltip("The graph is divided in multiple page.", target=page_selector_id, placement="bottom"),
					...
					html.Div(
						...
						children=[
							dbc.Button(
								html.I(className="bi bi-arrow-left-circle", style={"color": "white"}),
								id=prev_spike_id,
								n_clicks=0,
								outline=True,
								# style={
								...
								# 	# "fontSize": "1.5rem",
								# 	# "padding": "0.25rem",
								# 	"color": "white",  # You can adjust the color if needed
								# 	# "cursor": "pointer"
								# }
							),
							dbc.Tooltip("Move graph to previous spike", target=prev_spike_id, placement="bottom"),
							dcc.Dropdown(
							...
							dbc.Button(
								html.I(className="bi bi-arrow-right-circle", style={"color": "white"}),
								id=next_spike_id,
								n_clicks=0,
								outline=True
							),
							dbc.Tooltip("Move graph to next spike", target=next_spike_id, placement="bottom"),
						]
					),
				]
			),
