...
def get_grouped_channels_by_prefix(raw, bad_channels=None):
    ...
    if 'MEG' in meg_ch_names[int(len(meg_ch_names)/2)]:
        ...
        CHANNEL_GROUPS = {
            'MLC': ['MEG 004', 'MEG 006', 'MEG 007', 'MEG 008', 'MEG 009', 'MEG 010', 'MEG 011', 'MEG 012', 'MEG 020', 'MEG 021', 'MEG 022', 'MEG 023', 'MEG 024', 'MEG 025', 'MEG 026', 'MEG 027', 'MEG 037', 'MEG 038', 'MEG 039', 'MEG 040', 'MEG 041', 'MEG 042', 'MEG 043', 'MEG 044', 'MEG 045'], 
            'MLF': ['MEG 062', 'MEG 063', 'MEG 064', 'MEG 065', 'MEG 066', 'MEG 067', 'MEG 068', 'MEG 069', 'MEG 090', 'MEG 091', 'MEG 092', 'MEG 093', 'MEG 094', 'MEG 095', 'MEG 096', 'MEG 097', 'MEG 122', 'MEG 123', 'MEG 124', 'MEG 125', 'MEG 153', 'MEG 177', 'MEG 126', 'MEG 127', 'MEG 128', 'MEG 154', 'MEG 155'], 
            'MLO': ['MEG 161', 'MEG 162', 'MEG 163', 'MEG 164', 'MEG 183', 'MEG 184', 'MEG 185', 'MEG 200', 'MEG 201', 'MEG 202', 'MEG 203', 'MEG 217', 'MEG 218', 'MEG 219', 'MEG 235', 'MEG 236', 'MEG 237', 'MEG 238'], 
            'MLP': ['MEG 046', 'MEG 047', 'MEG 048', 'MEG 071', 'MEG 072', 'MEG 073', 'MEG 074', 'MEG 075', 'MEG 100', 'MEG 101', 'MEG 102', 'MEG 103', 'MEG 104', 'MEG 131', 'MEG 132', 'MEG 133', 'MEG 134', 'MEG 135', 'MEG 136'], 
            'MLT': ['MEG 070', 'MEG 098', 'MEG 099', 'MEG 129', 'MEG 130', 'MEG 156', 'MEG 157', 'MEG 158', 'MEG 159', 'MEG 160', 'MEG 178', 'MEG 179', 'MEG 180', 'MEG 181', 'MEG 182', 'MEG 196', 'MEG 197', 'MEG 198', 'MEG 199', 'MEG 212', 'MEG 213', 'MEG 214', 'MEG 215', 'MEG 216', 'MEG 229', 'MEG 230', 'MEG 231', 'MEG 232', 'MEG 233', 'MEG 234'], 
            
            'MRC': ['MEG 002', 'MEG 013', 'MEG 014', 'MEG 015', 'MEG 016', 'MEG 017', 'MEG 018', 'MEG 019', 'MEG 029', 'MEG 030', 'MEG 031', 'MEG 032', 'MEG 033', 'MEG 034', 'MEG 035', 'MEG 036', 'MEG 053', 'MEG 054', 'MEG 055', 'MEG 056', 'MEG 057', 'MEG 058', 'MEG 059', 'MEG 060'], 
            'MRF': ['MEG 081', 'MEG 082', 'MEG 083', 'MEG 084', 'MEG 085', 'MEG 086', 'MEG 087', 'MEG 088', 'MEG 113', 'MEG 114', 'MEG 115', 'MEG 116', 'MEG 117', 'MEG 118', 'MEG 119', 'MEG 120', 'MEG 146', 'MEG 147', 'MEG 148', 'MEG 149', 'MEG 150', 'MEG 151', 'MEG 152', 'MEG 174', 'MEG 175', 'MEG 176', 'MEG 195'], 
            'MRO': ['MEG 165', 'MEG 166', 'MEG 167', 'MEG 168', 'MEG 187', 'MEG 188', 'MEG 189', 'MEG 204', 'MEG 205', 'MEG 206', 'MEG 207', 'MEG 221', 'MEG 222', 'MEG 223', 'MEG 239', 'MEG 240', 'MEG 241', 'MEG 242'], 
            'MRP': ['MEG 049', 'MEG 050', 'MEG 051', 'MEG 052', 'MEG 076', 'MEG 077', 'MEG 078', 'MEG 079', 'MEG 106', 'MEG 107', 'MEG 108', 'MEG 109', 'MEG 110', 'MEG 138', 'MEG 139', 'MEG 140', 'MEG 141', 'MEG 142', 'MEG 143'], 
            'MRT': ['MEG 080', 'MEG 111', 'MEG 112', 'MEG 144', 'MEG 145', 'MEG 169', 'MEG 170', 'MEG 171', 'MEG 172', 'MEG 173', 'MEG 190', 'MEG 191', 'MEG 192', 'MEG 193', 'MEG 194', 'MEG 208', 'MEG 209', 'MEG 210', 'MEG 211', 'MEG 224', 'MEG 225', 'MEG 226', 'MEG 227', 'MEG 228', 'MEG 243', 'MEG 244', 'MEG 245', 'MEG 246', 'MEG 247', 'MEG 248'], 
            
            'MZC': ['MEG 001', 'MEG 003', 'MEG 005', 'MEG 028'], 
            'MZF': ['MEG 061', 'MEG 089', 'MEG 121'], 
            'MZO': ['MEG 220', 'MEG 186', 'MEG 137'], 
            'MZP': ['MEG 105']}
        ...
        CHANNEL_GROUPS = {
            'MLC': ['A4', 'A6', 'A7', 'A8', 'A9', 'A10', 'A11', 'A12', 'A20', 'A21', 'A22', 'A23', 'A24', 'A25', 'A26', 'A27', 'A37', 'A38', 'A39', 'A40', 'A41', 'A42', 'A43', 'A44', 'A45'], # 25 > 24
            'MLF': ['A62', 'A63', 'A64', 'A65', 'A66', 'A67', 'A68', 'A69', 'A90', 'A91', 'A92', 'A93', 'A94', 'A95', 'A96', 'A97', 'A122', 'A123', 'A124', 'A125', 'A153', 'A177', 'A126', 'A127', 'A128', 'A154', 'A155'], # 27 < 33
            'MLO': ['A161', 'A162', 'A163', 'A164', 'A183', 'A184', 'A185', 'A200', 'A201', 'A202', 'A203', 'A217', 'A218', 'A219', 'A235', 'A236', 'A237', 'A238'], # 18 < 19
            'MLP': ['A46', 'A47', 'A48', 'A71', 'A72', 'A73', 'A74', 'A75', 'A100', 'A101', 'A102', 'A103', 'A104', 'A131', 'A132', 'A133', 'A134', 'A135', 'A136'],# 19 < 22
            'MLT': ['A70', 'A98', 'A99', 'A129', 'A130', 'A156', 'A157', 'A158', 'A159', 'A160', 'A178', 'A179', 'A180', 'A181', 'A182', 'A196', 'A197', 'A198', 'A199', 'A212', 'A213', 'A214', 'A215', 'A216', 'A229', 'A230', 'A231', 'A232', 'A233', 'A234'], # 30 < 34

            'MRC': ['A2', 'A13', 'A14', 'A15', 'A16', 'A17', 'A18', 'A19', 'A29', 'A30', 'A31', 'A32', 'A33', 'A34', 'A35', 'A36', 'A53', 'A54', 'A55', 'A56', 'A57', 'A58', 'A59', 'A60'], # 24 = 24
            'MRF': ['A81', 'A82', 'A83', 'A84', 'A85', 'A86', 'A87', 'A88', 'A113', 'A114', 'A115', 'A116', 'A117', 'A118', 'A119', 'A120', 'A146', 'A147', 'A148', 'A149', 'A150', 'A151', 'A152', 'A174', 'A175', 'A176', 'A195'], #27 < 33
            'MRO': ['A165', 'A166', 'A167', 'A168', 'A187', 'A188', 'A189', 'A204', 'A205', 'A206', 'A207', 'A221', 'A222', 'A223', 'A239', 'A240', 'A241', 'A242'], # 18 < 19
            'MRP': ['A49', 'A50', 'A51', 'A52', 'A76', 'A77', 'A78', 'A79', 'A106', 'A107', 'A108', 'A109', 'A110', 'A138', 'A139', 'A140', 'A141', 'A142', 'A143',], # 19 < 22
            'MRT': ['A80', 'A111', 'A112', 'A144', 'A145', 'A169', 'A170', 'A171', 'A172', 'A173', 'A190', 'A191', 'A192', 'A193', 'A194', 'A208', 'A209', 'A210', 'A211', 'A224', 'A225', 'A226', 'A227', 'A228', 'A243', 'A244', 'A245', 'A246', 'A247', 'A248'], # 30 < 34
            
            'MZC': ['A1', 'A3', 'A5', 'A28'],# 4 = 4
            'MZF': ['A61', 'A89', 'A121'], # 3 = 3
            'MZO': ['A220', 'A186', 'A137'], #3 = 3
            'MZP': ['A105'] #1=1
        }
